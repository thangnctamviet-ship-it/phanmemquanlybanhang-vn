...
<section class="max-w-6xl mx-auto px-4 py-12">
  ...
  <div class="grid md:grid-cols-3 gap-6">
    <?php
    $plans = [
      ['id'=>'monthly','name'=>'Gói tháng','price'=>'120.000','sub'=>'₫ / tháng','note'=>'','months'=>1,'tag'=>''],
      ['id'=>'semiannual','name'=>'Gói 6 tháng','price'=>'600.000','sub'=>'₫ / 6 tháng','note'=>'Tiết kiệm 17%','months'=>6,'tag'=>'Phổ biến'],
      ['id'=>'annual','name'=>'Gói năm','price'=>'1.100.000','sub'=>'₫ / năm','note'=>'Tiết kiệm 24%','months'=>12,'tag'=>'Tốt nhất'],
    ];
    foreach($plans as $p): ?>
    <div class="bg-white rounded-lg shadow-sm p-6 border-2 <?= $p['tag']==='Tốt nhất'?'border-indigo-500':'border-transparent' ?>">
      ...
      <a href="register.php?plan=<?= urlencode($p['id']) ?>" class="mt-6 block text-center bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700">Đăng ký ngay</a>
    </div>
    <?php endforeach; ?>
  </div>
</section>
