        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Nhập điện thoại khách hàng" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                            <input type="text" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control" disabled value="<?php echo format_vnd($val['rate']) ?>" autocomplete="off">
                            <input type="hidden" name="rate_value[]" id="rate_value_<?php echo $x; ?>" class="form-control" value="<?php echo $val['rate'] ?>" autocomplete="off">
                          </td>
                          <td>
                            <input type="text" name="amount[]" id="amount_<?php echo $x; ?>" class="form-control" disabled value="<?php echo format_vnd($val['amount']) ?>" autocomplete="off">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" disabled value="<?php echo format_vnd($order_data['order']['gross_amount']) ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge" disabled value="<?php echo format_vnd($order_data['order']['service_charge']) ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge" disabled value="<?php echo format_vnd($order_data['order']['vat_charge']) ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Giảm giá" onkeyup="subAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Thành tiền ròng</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" disabled value="<?php echo format_vnd($order_data['order']['net_amount']) ?>" autocomplete="off">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Trạng thái thanh toán</label>
                    <div class="col-sm-7">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >In</a>
...
<script type="text/javascript">
  ...
  function subAmount() {
    ...
    if(paid_amount) {
      var remaning = grandTotal - paid_amount;
      $("#remaining").val(formatVND(remaning));
      $("#remaining_value").val(remaning);
    }
  ...
  function paidAmount() {
    ...
    if(grandTotal) {
      var dueAmount = grandTotal - Number($("#paid_amount").val());
      $("#remaining").val(formatVND(dueAmount));
