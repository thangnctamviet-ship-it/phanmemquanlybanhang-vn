...
class Users extends Admin_Controller
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Người dùng';
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('username', 'Tên đăng nhập', 'trim|required|min_length[5]|max_length[12]|is_unique[users.username]');
